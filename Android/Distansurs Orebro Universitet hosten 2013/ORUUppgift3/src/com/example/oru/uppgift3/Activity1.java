...
public class Activity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		texten.setText("Detta Šr aktivitet 1.");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		item_act1.setEnabled(false); // we are in this view, not sure why we want to go here again.
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (menyvalet) {
			case MENU_ACTIVITY2:
			{
				Intent the_act2_intent = new Intent(Activity1.this, Activity2.class);
				startActivity(the_act2_intent);
				break;
			}
			case MENU_ACTIVITY3:
			{
				Intent the_act3_intent = new Intent(Activity1.this, Activity3.class);
				startActivity(the_act3_intent);
				break;
			}
