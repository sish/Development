...
public class Activity2 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		texten.setText("Detta Šr aktivitet 2.");
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		item_act2.setEnabled(false); // we are in this view, not sure why we want to go here again.
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (menyvalet) {
			case MENU_ACTIVITY1:
			{
				Intent the_act1_intent = new Intent(Activity2.this, Activity1.class);
				startActivity(the_act1_intent);
				break;
			}
			case MENU_ACTIVITY3:
			{
				Intent the_act3_intent = new Intent(Activity2.this, Activity3.class);
